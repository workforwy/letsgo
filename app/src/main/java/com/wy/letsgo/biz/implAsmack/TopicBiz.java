...
import com.wy.letsgo.parser.TopicParser;
...
public class TopicBiz {
    ...
    public static void createTopic(final UserEntity userEntity, String content, byte[] imageData,
                                   String address, String latitude, String longitude, String time) {
