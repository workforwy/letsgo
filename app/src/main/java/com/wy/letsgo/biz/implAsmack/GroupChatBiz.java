        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    //问题1在短连接中不存在
                    //问题2在短连接中有sessiion存在
                    if (TApplication.networkType == TApplication.NETWORKTYPE_NONE) {
                        //没网
